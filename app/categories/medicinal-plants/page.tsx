...
export const metadata: Metadata = {
  ...
  description:
    "Scientific studies of medicinal plants, including botanical identification, traditional and contemporary applications, plant extracts, biological activity, and experimental evaluation.",
};
